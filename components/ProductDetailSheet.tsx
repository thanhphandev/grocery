...
import { detailImageUrl } from "@/lib/cloudinary";
import {
  addHistory,
  deleteProduct,
  formatPrice,
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <Input
                          value={editRetail}
                          onChange={(e) =>
                            setEditRetail(e.target.value.replace(/\D/g, ""))
                          }
                          inputMode="numeric"
                      ...
                      <div>
                        ...
                        <Input
                          value={editWholesale}
                          onChange={(e) =>
                            setEditWholesale(e.target.value.replace(/\D/g, ""))
                          }
                          inputMode="numeric"
                          className="h-11 rounded-xl font-mono"
                        />
                  ...
                  >
                    ...
                    <div className="flex gap-4 mb-5">
                      {product.image && (
                        ...
                        >
                          <NextImage
                            src={detailImageUrl(product.image) || product.image}
                            alt={product.name}
                            fill
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          <Badge
                            variant="outline"
                            className="gap-1 px-2 py-0.5 h-6 text-xs font-medium"
                          >
